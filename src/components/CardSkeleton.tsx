export default function CardSkeleton() {
  return (
    <div className="w-70 h-90 flex-none bg-white dark:bg-[#1f2937] rounded-2xl overflow-hidden shadow-md dark:shadow-lg border border-gray-200 dark:border-gray-700/50 animate-pulse">
      {/* Espaço da Bandeira */}
